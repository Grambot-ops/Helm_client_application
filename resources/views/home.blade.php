            ...
            <div class="w-full rounded overflow-hidden shadow-lg">
                ...
                <div class="px-6 py-4">
                    <div class="justify-between flex mb-2">
                        ...
                        <div class="text-red-800 font-bold mt-1">closed <x-phosphor-lock-simple class="inline-block w-6 h-6 mb-1"/></div>
                    </div>
                ...
                <div class="px-6 pt-4 pb-2">
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Science/Engineering</span>
                </div>
                <div class="px-6 pt-2 pb-4 flex justify-between">
                    <div>
                        <button class="bg-tm-orange hover:bg-tm-darker-orange transition text-white font-bold py-2 px-4 rounded">
                            See more info
                        </button>
